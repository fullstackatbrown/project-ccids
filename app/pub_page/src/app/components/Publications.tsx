    ...
    <div style={{ fontFamily: baseFont, background: "#fff", minHeight: "100vh" }}>
      ...
      >
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: 32 }}>
          {[
            ...
            <a
              ...
              style={{
                ...
                color: "#000",
                textDecoration: "none",
                fontWeight: label === "Publications" ? 700 : 400,
              }}
            >
              {label}
            </a>
          ...
          <a
            href="https://sites.brown.edu/ccids/newsletter/"
            target="_blank"
            rel="noopener noreferrer"
            style={{
              background: "#027BBF",
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
              {[
                { label: "Join Us", href: "https://sites.brown.edu/ccids/join-us/" },
                { label: "Members", href: "https://sites.brown.edu/ccids/members/" },
                { label: "Events", href: "https://sites.brown.edu/ccids/events/" },
                { label: "News", href: "https://sites.brown.edu/ccids/news/" },
                { label: "Publications", href: "https://sites.brown.edu/ccids/publications/" },
              ].map(({ label, href }) => (
                <a
                  key={label}
          ...
          <div style={{ display: "flex", gap: 60, flexWrap: "wrap", alignItems: "flex-start" }}>
            {/* Contact */}
            <div>
              <p style={{ fontFamily: baseFont, fontSize: 18, fontWeight: 700, margin: "0 0 16px" }}>
                Contact Us
              </p>
              <p style={{ fontFamily: baseFont, fontSize: 16, margin: "0 0 8px" }}>
                Email:{" "}
                <a href="mailto:brownmocktrial@gmail.com" style={{ color: "#fff", textDecoration: "underline" }}>
                  brownmocktrial@gmail.com
                </a>
              </p>
              <p style={{ fontFamily: baseFont, fontSize: 16, margin: 0 }}>
                Instagram:{" "}
                <a
                  href="https://www.instagram.com/brownmocktrial"
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        {/* Divider */}
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.4)", margin: "0 0 28px" }} />
        ...
        >
          <p style={{ fontFamily: baseFont, fontSize: 15, margin: 0, fontWeight: 600 }}>
            © 2026{" "}
            <a
              href="https://sites.brown.edu/ccids/"
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: "#fff", textDecoration: "underline" }}
            >
              Center for Clinical Cancer Informatics and Data Science (CCIDS) at Brown University
            </a>
            . All Rights Reserved.
          </p>
          <a
            href="https://sites.brown.edu/ccids/privacy-policy/"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "#fff", fontSize: 15, textDecoration: "underline", fontWeight: 600 }}
          >
            Privacy Policy
          </a>
        </div>
